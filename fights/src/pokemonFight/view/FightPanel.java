...
public class FightPanel extends JPanel {
	...
	public FightPanel() throws IOException {
		...
		allyPokemonLifeBarLbl.setIcon(new ImageIcon("fights/contents/pokemonStatus/pokemonLifeBar.png"));
		add(allyPokemonLifeBarLbl);

		JLabel enemyLifeBarLbl = new JLabel();
		enemyLifeBarLbl.setBounds(0, 11, 299, 80);
		enemyLifeBarLbl.setIcon(new ImageIcon("fights/contents/pokemonStatus/enemyLifeBar.png"));
		add(enemyLifeBarLbl);
		...
		if (!StatusSingleton.getInstance().getPokemonTeam().isEmpty()) {
			...
			layoutFirstClrLbl.setIcon(new ImageIcon("fights/contents/layoutColours/DecissionMenuClr.png"));
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "No se han cargado las canciones.", "ERROR!",
						JOptionPane.ERROR_MESSAGE);
